  ...
  class Transport
    ...
    def read_next_frame(opts = {})
      ...
      if frame_end != AMQ::Protocol::Frame::FINAL_OCTET
        @logger.error("AMQP bad frame. type: #{type.inspect}, channel: #{channel.inspect}, size: #{size}, frame_end.class: #{frame_end.class}, payload: #{Base64.strict_encode64(payload)}")
